...
- **Music:** 34.4% on MAESTRO v3.0.0 concert piano dataset (1,276 performances, 33,454 test phrases), above both persistence and random baselines — proves universal architecture processes temporal art
