...
- **Chess:** 61.4% accuracy on 343K+ 3-way predictions (p ≈ 0, z > 100)
- **Market:** 42.9% directional accuracy (3-way), tactical chess→market patterns at 47.1%
...
|---|---|---|---|
| Chess predictions (3-way) | 50,000+ | 61.4% | p ≈ 0 (z > 100) |
