...
|---|---|---|---|---|
| **Chess** (temporal pattern) | 343,000+ games | 61.4% (3-way) | 33.3% random | p ≈ 0, z > 100 |
| **Market** (directional) | 21,000+ resolved | 42.9% (3-way) | 33.3% random | Tactical patterns at 47.1% |
